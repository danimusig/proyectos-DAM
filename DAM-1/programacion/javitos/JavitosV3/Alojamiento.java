 ...
 * @see Id
 */
@NamedQuery (name="datosAlojamiento", query="SELECT a FROM Alojamiento a")
@NamedQuery (name="borrarTodosLosAlojamientos", query="DELETE FROM Alojamiento a")

@Entity public class Alojamiento implements Comparable<Alojamiento>, Serializable{
    /**

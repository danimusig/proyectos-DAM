 ...
 * 
 */
@NamedQuery (name="datosCliente", query="SELECT c FROM Cliente c")
@NamedQuery (name="borrarTodosLosClientes", query="DELETE FROM Cliente c")

@Entity public class Cliente implements Comparable<Cliente>, Serializable{
    /**

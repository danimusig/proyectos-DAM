...
public class Alojamiento implements Comparable<Alojamiento>{
     ...
     * @param disponible Si esta disponible o no.
     * @param vecesAlquilado El numero de veces alquilado.
     */
    public Alojamiento(String nombre, int capacidad, double tarifa, boolean tieneChimenea, boolean tieneJacuzzi) {
        ...
        this.disponible = true; //Cuando el alojamiento se crea esta disponible automaticamente.
        this.vecesAlquilado = 0; //Inicio en el constructor el contador.    
    }
     ...
     * @param tarifa la nueva tarifa del alojamiento por noche.
     */
    ...
    /**
     * Obtiene si el alojamiento esta disponible.
     * @return Si el alojamiento esta disponible en un boolean.
     */
    ...
    /**
     * Modifica si el alojamiento esta disponible.
     * @param disponible Si el alojamiento esta disponible en un boolean.
     */
     ...
     * @param vecesAlquilado Las veces que se ha alquilado el alojamiento en un entero.
     */
